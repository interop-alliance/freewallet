...
Code style and contribution conventions for Freewallet. Coding agents receive
this file via the include in [AGENTS.md](AGENTS.md); for a map of the codebase,
